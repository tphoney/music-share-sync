 ...
 */
public interface TreeStateManager<T,S> extends Serializable {
     ...
     * @return node info
     */
    TreeNodeInfo<T,S> getNodeInfo(T id);
     ...
     * @param params
     *            additional properties we might be interested on keeping for this node
     */
    void addBeforeChild(T parent, T newChild, T beforeChild, S params);
     ...
     *            additional properties we might be interested on keeping for this node
     */
    void addAfterChild(T parent, T newChild, T afterChild, S params);
