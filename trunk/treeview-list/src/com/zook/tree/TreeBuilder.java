...
public class TreeBuilder<T> {
     ...
     *            child id
     */
    public synchronized void addRelation(final T parent, final T child, final String description) {
        Log.d(TAG, "Adding relation parent:" + parent +  " -> child: " + child  +  " -> description: " + description);
        manager.addAfterChild(parent, child, null, description);
        lastAddedId = child;
     ...
     *            its folder name
     */
    public synchronized void sequentiallyAddNextNode(final T id, final int level, final String description) {
    ...
    private void addNodeToParentOneLevelDown(final T parent, final T id,
            final int level, final String description) {
